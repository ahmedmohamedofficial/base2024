                            ...
                            <form  method="POST" action="{{route('admin.countries.store')}}" class="store form-horizontal needs-validation" novalidate>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <x-admin.inputs.text name="country_code" type="number" label="{{__('admin.country_code')}}"  required placeholder="{{__('admin.enter_country_code')}}"  inValidMessage="{{ __('admin.this_field_is_required') }}" />
                                        </div>
                                        <div class="col-md-4 col-12">
                                            <x-admin.inputs.text name="iso2" type="text" label="ISO"  required placeholder="ISO"  inValidMessage="{{ __('admin.this_field_is_required') }}" />
                                        </div>
